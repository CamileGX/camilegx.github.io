...
export const assistants = [
  { icon:"✦", name:"Dexie", role:"Orchestrator", description:"Coordinates your context, decisions, and next best move." },
  { icon:"⌘", name:"Coding", role:"Build partner", description:"Turns intent into clean systems, components, and useful tools." },
  { icon:"⌕", name:"Research", role:"Signal finder", description:"Explores sources, spots patterns, and distills what matters." },
  { icon:"◒", name:"Creative", role:"Idea amplifier", description:"Helps shape directions, stories, and surprising connections." },
  { icon:"◉", name:"System", role:"Operations", description:"Keeps routines, automation, and your digital environment in tune." }
];
export const documents = ["Welcome to DexieOS", "Operating principles", "Project architecture", "Research workflow", "Interface vocabulary"];
